    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <div className="mt-5 relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 text-sm text-[#1d1d1f] bg-white border border-[#e8e8e8] rounded-lg outline-none focus:border-[#1d1d1f] focus:ring-2 focus:ring-[#1d1d1f]/5 transition-colors placeholder:text-[#6b7280]"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
                aria-label="Clear search"
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6b7280] hover:text-[#1d1d1f] transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <select
              ...
              className="text-sm text-[#1d1d1f] bg-white border border-[#e8e8e8] rounded-lg px-3 py-2 outline-none focus:border-[#1d1d1f] focus:ring-2 focus:ring-[#1d1d1f]/5 transition-colors cursor-pointer"
            >
        ...
        {filtered.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <button
              onClick={() => setSearch("")}
              className="mt-4 px-4 py-2 text-sm font-medium text-white bg-[#1d1d1f] rounded-lg hover:bg-[#3a3a3c] transition-colors"
            >
              View all products
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-[#0F172A] rounded-2xl px-6 py-10 sm:px-10 sm:py-12 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-[10px] font-medium text-white/50 uppercase tracking-[0.18em] mb-2">
              Need help choosing?
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-medium text-[#1d1d1f] bg-white/90 rounded-lg hover:bg-white transition-colors"
            >
              Send an Enquiry
            </a>
          </div>
