        ...
        <div className="bg-white border-b border-slate-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
            ...
            <nav className="flex items-center gap-1.5 text-sm text-[#64748B] mb-4">
              ...
              <span className="text-[#092145] font-medium">About</span>
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 flex flex-col gap-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="p-5 flex flex-col gap-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center justify-between py-2 border-b border-slate-100 last:border-0">
                      ...
                      <span className="text-sm font-medium text-[#092145]">{item.value}</span>
                    </div>
                  ))}
                  <a
              ...
              <div className="lg:col-span-2 flex flex-col gap-5">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-[#092145] tracking-tight mb-4">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  {[
                    ...
                    <span
                      key={badge}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[#092145] bg-white border border-slate-200 rounded-full"
                    >
          ...
          <section>
            <div className="mb-8">
              ...
              <h2 className="text-2xl font-bold text-[#092145] tracking-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {WHAT_WE_DO.map((item) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-[#092145] mb-1.5">{item.title}</h3>
          ...
          <section>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div>
                ...
                <h2 className="text-2xl font-bold text-[#092145] tracking-tight mb-3">
                ...
                {WHY_CHOOSE_US.map((item) => (
                  <div key={item.title} className="bg-white border border-slate-200 rounded-xl p-5">
                    <div className="flex items-start gap-3 mb-2">
                      ...
                      <h3 className="text-sm font-semibold text-[#092145]">{item.title}</h3>
                    </div>
