            ...
            <div className="mt-5 relative max-w-md">
              ...
              {search && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#0066FF] transition-colors"
                >
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-xs font-semibold
                      ${isActive ? "bg-[#0066FF] text-white" : "bg-slate-100 text-[#64748B]"}`}
                    >
                      {count}
                    </span>
                  </button>
