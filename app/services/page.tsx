            ...
            <div className="bg-[#092145] rounded-2xl px-6 py-10 sm:px-10 sm:py-12 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-semibold text-[#092145] bg-white rounded-xl hover:bg-slate-100 transition-colors"
                >
