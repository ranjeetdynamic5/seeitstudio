        ...
        <div className="flex flex-col-reverse lg:flex-row lg:items-center gap-8 lg:gap-12 py-12 lg:py-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/training"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/[0.08] text-white text-sm font-semibold rounded-lg hover:bg-white/[0.14] border border-white/[0.1] transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
